...
public class SecurityController implements Initializable {
    ...
    @FXML
    private Label potentialText;

    @FXML
    private CheckBox proxyCheck;

    @FXML
    private Label safeipText;
    ...
    private void updateLabels(Ipapi ipInfo) {
        ...
        threatText.setText(ipInfo.getSecurity().getThreatLevel());

        // Proxy -------------------

        proxyCheck.selectedProperty().setValue(ipInfo.getSecurity().getIsProxy());

        // Crawler -------------------

        crawlerCheck.selectedProperty().setValue(ipInfo.getSecurity().getIsCrawler());

        // Tor -------------------

        torCheck.selectedProperty().setValue(ipInfo.getSecurity().getIsTor());
